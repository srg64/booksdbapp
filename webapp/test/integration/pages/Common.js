sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("de/asr/library/booksdbapp/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#LibraryApp-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#LibraryApp-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("de.asr.library.booksdbapp.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["de/asr/library/booksdbapp/localService/mockserver"], function(mockserver) {
